...
- **Mechanism:** flat deduction after the weighted total in  — **−6** if , **−3** if  (unguaranteed/waitlisted), 0 if true. The four weights are untouched; 95 of 110 schools' scores are unchanged.
