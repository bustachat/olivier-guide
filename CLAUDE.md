...
**Current version: v45.44 (2026-09-15).** Always confirm against `git log --oneline -1` and `guideVersion` in `athletes/olivier.json` — do not trust this line alone. It has sat stale for as many as 13 versions at a time, which is the clearest evidence available that a bloated section stops being read.
...
#### Batch 7 — the remaining 38 schools on 2025-26 rosters (planned 2026-09-14, not started)
...
| **7I — Region 24 (IL)** | `southwestern_illinois`, `lincoln_trail` | Small closing batch. |
...
**Afterwards:** the 4-year schools refreshed here get rechecked in the January 2027 portal recheck (the cloud reminder already exists). Schools left on outcome (b) at the end of October get one final look in November, then are recorded as "no 2026-27 roster published" for the season.
