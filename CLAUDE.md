...
- **`roster_season` doubles as the roster-refresh ledger** — the Minutes Outlook tab shows at a glance which schools are on 2026-27 data and which are still on an older season (now with an explicit ✓/⏳ badge and filter as of v45.03, see below). **Recount as of v45.45 (Batch 7 close-out, 2026-09-15): 150 on 2026-27 / 8 on 2025-26 / 12 `available:false`** (170 total; verified on the live site). The 8 are listed with reasons in §6C Batch 7. The v45.02 figure below (119/39/12) is superseded. This supersedes every prior count in this ledger's history (64/51/7 at v44.55; 83/71/16 mid-gap-fill-campaign) — Batch 5's 10 sub-batches re-verified all 56 gap-fill JUCOs and moved a large share of them onto fresh 2026-27 data in the process. Of the 39 still on an older season, most are genuinely current for their school (the newest season that school has published) rather than a research gap — recheck via the transfer-portal schedule below, not by re-deriving this count from memory.
...
- **🚩 `wilbur_wright_college`'s Gabriel Billings — genuinely ambiguous, left unchanged (v45.30).** A dated (2025-11-19) article directly quotes him as head coach. A June 2026 article about his new, additional hire as Eureka College's women's soccer coach describes his Wright role in past-tense-leaning CV language, which could mean he's stepped back from day-to-day coaching there (he remains Wright's Athletic Director either way) — or could just be standard CV framing while he holds both roles. No successor was found, so the entry was left as-is rather than acted on an ambiguous signal. Re-check once the 2026-27 Wright roster/coaches page is live.
...
**The 8 still on 2025-26, and why (re-check these next, not the whole list):**

| School | Reason (2026-09-15) | Re-check trigger |
|---|---|---|
| `monroe_college` | 2026 roster is a 59-player **four-year** roster (NCAA D2 transition, §6F). **Owner ruling: leave for now.** | Division decision (~2027) |
| `truman_college` | Region 4 site has no 2026-27 season; NJCAA roster has positions but **every class year blank** | Class years published on either source |
| `kennedy_king_college` | Region 4 site has no 2026-27 season; NJCAA roster has only **1 GK** (§15 GK test) | A second GK or a school-site roster |
| `wilbur_wright_college` | Region 4 site has no 2026-27 season; NJCAA says "No roster available" | Any roster published |
| `trinidad_state` | Own page and NJCAA both list 29 names with ~22 positions/classes blank | Fields filled in |
| `pacific_northwest_christian_college` | Own page and NJCAA both list 15 players, 10–11 positions blank, 1 GK | Fields filled in |
| `harcum_college` | Own page 17 players / 1 GK; NJCAA "No roster available" | NJCAA roster appears or squad completes |
