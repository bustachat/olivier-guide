...
function renderCards(){
  ...
  const CONF_SECTIONS=[
    ...
    {key:'other', divFilter:'D3',      label:'NCAA Division III',        tier:'D3',            intro:'Chapman University (Orange, CA) offers Applied Human Physiology (formerly Kinesiology) and runs its own Doctor of Physical Therapy program on campus. D3 schools offer no athletic scholarships but provide strong academics and competitive soccer.'},
    {key:'other', divFilter:'JUCO',    label:'Junior College (JUCO)',    tier:'JUCO',          intro:'Tyler Junior College (Tyler, TX) has the highest measured NCAA Division I transfer rate of any JUCO in this guide (about 6.6 a year, 2012-2023), and were beaten by Montgomery College at the 2025 National Tournament. Daytona State College (Daytona Beach, FL) are the 2025 NJCAA DI National Championship runners-up — warm Florida beach city. Indian Hills CC (Ottumwa, IA) are the 2025 NJCAA DI National Champions under Zac Newton. Monroe University Mustangs (New Rochelle, NY) are 3× NJCAA DI National Champions with Australian alumni on roster. Santa Monica College has the best UCLA transfer pipeline in California. Cowley County CC and Barton CC (both KS) were ranked in the 2025 national top 5. Arizona Western College (#2 nationally, 2025) pairs a genuine Exercise/Wellness/Nutrition degree with a warm desert climate. Eastern Florida State plays in a 1,000-seat stadium-grade facility on Florida\'s Space Coast. Murray State College (Tishomingo, OK) are back-to-back NJCAA DI National Tournament qualifiers (2024, 2025) and the guide\'s most freshman-open intake — all 17 freshmen on the 2026-27 roster entered straight from high school, including an Australian from Sydney. Otero College (La Junta, CO) swept the 2025 Region 9/Tournament/District titles and won Otero\'s first-ever NJCAA national tournament match. Montgomery College (Rockville, MD) swept the 2025 Region 20/MDJUCO/District titles under USSF \'B\'-licensed HC Pedro Braz and has a CAAHEP-accredited Exercise Science degree. Yavapai College (Prescott, AZ) is a seven-time NJCAA national champion program that reached the 2025 Region 1 Championship final. College of Southern Nevada (Las Vegas, NV) is set in a genuine major city, with a fully accredited Physical Therapist Assistant AAS. Region 2 (Oklahoma/Arkansas) now fields seven guide schools alongside Murray State: Eastern Oklahoma State College (three straight Region 2 postseason finals, 2023-2025), Rose State College (genuine Oklahoma City metro access, the group\'s best academic fit), Northeastern Oklahoma A&M College (best-staffed athletic training department), Connors State College (a young program), National Park College (a new NJCAA Division II program, founded 2024, with a winning 2025-26 record), and University of Arkansas Rich Mountain (outright Region 2 champion in 2019 and 2021, now led by a five-time NCAA D1 head coach). Region 5 (Texas) debuts with Hill College (winless in conference in 2024 to Region 5 regular-season champions and Tournament runner-up in 2025, one of the guide\'s lowest-cost JUCOs at $9,390/yr) and Western Texas College (2025 Region 5 Tournament Champion and NJCAA Mid-South District runner-up, with an officially confirmed dedicated on-campus soccer complex). Region 4 (Chicago) debuts with all five City Colleges of Chicago programs: Harry S. Truman College (NJCAA Region 4 DI champion three consecutive seasons, 2023-2025, under three-time Region 4 Coach of the Year Maciej Orlowski), Richard J. Daley College (a genuine 3-year coaching turnaround from 1-11-3 to 8-6), Malcolm X College (the only campus with real on-campus exercise-science coursework, at CCC\'s $251M Health Sciences center), Kennedy-King College, and Wilbur Wright College (a newly NJCAA Foundation-grant-funded, still-developing program) — all five are commuter campuses with zero on-campus housing anywhere in the City Colleges of Chicago district. Region 6 (Kansas) adds Coffeyville Community College (NJCAA Academic Team of the Year 2025-26 for men\'s soccer, a dedicated Athletic Training AS degree), Garden City Community College (a \'historic\' 2025 season under program-alumnus HC Oscar Zelaya, a player on Garden City\'s own #4-nationally-ranked 2008 national-tournament team), and Seward County Community College (the guide\'s youngest Kansas program, launched fall 2023, under founding HC Jaime Beltran, a 2013 NJCAA DI Region 5 Champion at Ranger College). Region 9 grows to six guide schools alongside Otero College with five Wyoming programs: Laramie County Community College (11X Region IX Champions per the team\'s own account, a brand-new $31M athletics complex, and a strong ACU-aligned Kinesiology degree), Casper College (a sustained NCAA D1/D2/NAIA transfer pipeline under program-founder HC Ben McArthur, 2 confirmed 2025 NJCAA All-Americans), Northwest College (led by UEFA \'B\'-licensed HC Rob Hill, who returned the program to a 2025 Region 9 final), Gillette College (a purpose-built 2020 soccer field and a new $18.5M academic-athletic complex), and Central Wyoming College (a program in an early rebuilding phase under a first-season HC). Region 9 grows further to ten guide schools with four Colorado/Nebraska programs: Western Nebraska Community College (2024 Region IX regular-season and tournament champion, first-ever NJCAA DI National Tournament appearance, and the program\'s first-ever NJCAA All-American, Eduardo Oliveira — at a low cost of attendance of $14,125/yr), Trinidad State College (program alumnus HC Tyler Wilt returned in 2025 after four years as head coach at York University, Nebraska, and a named, direct AA-to-BS Exercise Science transfer agreement, with CSU Pueblo), Northeastern Junior College (Interim HC Hubert Blanco, whose own CV includes multiple high school district titles and a regional championship), and Lamar Community College (a genuine Athletic Training Practicum clinical sequence under new HC Alieu Kamara, owner of a professional academy in Guinea, inheriting the region\'s weakest recent on-field record). Region 10 (South Carolina) debuts with all four of the region\'s DI programs: USC Lancaster (2025 Region 10 DI Tournament Champion and NJCAA Southeast District Runner-up under six-year HC Kenny Halas), USC Sumter (2024-25 Region 10 regular-season champion, 10-1-2, under first-year HC Adam Howarth, whose CV spans NCAA D1/D2/D3 and a pro career in Finland), USC Union (the program\'s best-ever 2025-26 season and four consecutive Region 10 DI Players of the Year, 2022-2025, under 2x Coach of the Year Marc Curlee), and USC Salkehatchie (long-serving HC William Glass, offsetting recent on-field decline) — none of the four offers a dedicated Exercise Science/Kinesiology credential or on-campus housing. Region 14 (Texas) debuts with four schools sharing one conference bracket: Paris Junior College (a fast-growing transfer pipeline under HC Fernando Arellano, a former NCAA D1 player and NJCAA All-American — a program-record 10 transfer signings in June 2026), Northeast Texas Community College (HC Jon Evan carries assistant-coaching experience at two different NCAA D1 programs and an NCAA D2 head-coaching title, despite Region 14\'s weakest current record), Jacksonville College (a very small school of ~550 students, with a large midfield group), and Texas Southmost College (a new program, launched 2023-24 under founding HC and TSC/UTB alumnus Mario Zamora, the only one of these four on a real city campus but with no on-campus housing). Region 16 (Missouri) and Region 19 (Pennsylvania) debut, and Region 20 grows to three schools: Crowder College won the 2025 Region 16 Tournament and reached the Plains District Tournament in first-year HC Hunter Gilliam\'s debut season (Silas Laytham, NJCAA D1 3rd Team All-American); rival Jefferson College, led by program alumnus HC Luke Schlichting, reached the same final and carries a real UCM Kinesiology, BS articulation agreement. Harcum College has a decorated on-field record — a 2020-21 NJCAA DI National Championship Tournament Final Four (beating Western Texas College at Nationals) plus 2020 and 2024 East District titles under HC David Hughes (UEFA B License, former Carlisle United FC player), backed by a genuine clinical Physical Therapist Assistant degree, though it carries the highest cost of attendance of any JUCO in the guide. Hagerstown Community College (a measured 3-season coaching turnaround under Joe Mills, 0-15-1 to 12-6-1) and Harford Community College (the program\'s first Region 20 title in 50 years in 2024 plus a first-ever 2021 National Tournament berth, under HC Bill Wardle\'s personally-built international recruiting network) join Montgomery College in Region 20; both moved to NJCAA Division II for 2026-27, and neither offers on-campus housing. Region 18 (Utah/Idaho/Colorado/Nevada/Washington, Scenic West Athletic Conference) debuts with all eight schools sharing one conference bracket: Salt Lake CC is the strongest on-field program of the eight — an undefeated 17-0 2021 NJCAA DI National Championship followed by four straight conference titles (2022-2024) and a 2025 Region 18 Tournament title, under HC Mark Davis, in the guide\'s only genuine major-city Utah campus. Snow College won the program\'s first-ever conference title in 2025 and produced an NJCAA All-American (Isaac Stanley), now under brand-new HC Lewis Wilson, an 8-year Aberdeen FC Academy product. Utah State Eastern\'s HC Bruce Palmbaum holds a USSF \'A\' Coaching License and NCAA Division I head-coaching experience (University of Tulsa) — an unusually deep individual coaching CV — and USU Eastern offers a genuine on-site Health Science BS with real Kinesiology coursework. North Idaho College (a real dedicated Eisenwinter Field, cadaver-based anatomy coursework) and Truckee Meadows CC (a real dedicated soccer field, and the guide\'s other genuine Region 18 city-lifestyle match at Reno, NV) round out the group\'s steadier programs. College of Southern Idaho and Colorado Northwestern CC are both still-developing: CSI improving as a young program under founding HC Alex Ferreira, and Colorado Northwestern in a genuine multi-season rebuild now under new HC Dave Brown, who arrives from an NJCAA regional-championship coaching staff. Pacific Northwest Christian College is a very young, not yet established program (1-39 across its first three seasons), now under a brand-new first-time HC, at one of the lowest costs of attendance in the guide. Region 24 (Illinois) grows to four guide schools alongside Lewis & Clark CC: Illinois Central College (Region 24 titles in 2022 and 2025, No. 12 nationally in 2024), Southwestern Illinois College (HC Lindsay Eversmeyer, the first and only woman ever to play men\'s professional soccer), and Lincoln Trail College (a program mid-rebuild under new HC Luis Dantas, an NCAA D1 transfer and 3-season professional indoor soccer veteran). Also in the JUCO section: Central Georgia Technical College (Region 17, GA) — a program launched 2023, improving year over year, on a real dedicated Atrium Health Field, paired with a CAPTE-accredited Physical Therapist Assistant degree — and Ranger College (Region 5, TX) — three straight above-.500 seasons under an NAIA All-Conference alumnus head coach. Northern Oklahoma College-Enid (Region 2, OK) becomes the region\'s eighth guide school, home to a genuinely elite $12 million soccer complex (1,500-seat stadium, six full turf fields), though its program is mid-rebuild under an interim head coach appointed in August 2026. All 89 JUCO programs are 2-year transfer platforms. New for 2026-27: NorthWest Arkansas Community College (Region 2, AR), a brand-new program under former Loyola Marymount associate head coach Dean Johnson with a CAPTE-accredited PTA degree; Southern Crescent Technical College (Region 17, GA) and Southwestern Christian College (Region 5, TX), both young programs; and Oxford College of Emory University (Region 17, GA), Emory\'s two-year campus, shown as NJCAA Division III because Emory says it cannot offer athletic scholarships.'},
  ];
...
const DOMAINS = {
  ...
  yavapai_college: 'ycathletics.com',
  eastern_arizona: 'eacmonsters.com',
  csn_college: 'csncoyotes.com',
  community_christian_college: 'cccollegeathletics.com',
  eastern_oklahoma_state: 'eoscathletics.com',
  connors_state: 'connorsathletics.com',
  neo_am: 'neoathletics.com',
  rose_state: 'rscraiders.com',
  national_park: 'athletics.np.edu',
  rich_mountain: 'bucksathletics.com',
  hill_college: 'hillcollegeathletics.com',
  western_texas: 'wtcathletics.com',
  truman_college: 'region4sports.com',
  daley_college: 'region4sports.com',
  malcolm_x_college: 'region4sports.com',
  kennedy_king_college: 'region4sports.com',
  wilbur_wright_college: 'region4sports.com',
  coffeyville_cc: 'redravenathletics.com',
  garden_city_cc: 'gobroncbusters.com',
  seward_county_cc: 'sewardsaints.com',
  casper_college: 'tbirds.cc',
  northwest_college: 'nwctrappers.com',
  central_wyoming: 'rustlerathletics.com',
  laramie_county_cc: 'golccc.com',
  gillette_college: 'gcpronghorns.com',
  western_nebraska_cc: 'wnccathletics.com',
  lamar_cc: 'golopes.com',
  trinidad_state: 'tsctrojans.com',
  northeastern_junior_college: 'gonjc.com',
  usc_lancaster: 'usclathletics.com',
  usc_salkehatchie: 'uscsalkathletics.com',
  usc_sumter: 'uscfireants.com',
  usc_union: 'uscunionathletics.com',
  paris_jc: 'pjcathletics.com',
  jacksonville_college: 'athletics.jacksonvillecollege.edu',
  northeast_texas_cc: 'ntcceagles.com',
  texas_southmost: 'tscscorpions.com',
  crowder_college: 'crowderathletics.com',
  jefferson_college_mo: 'athletics.jeffco.edu',
  harcum_college: 'harcum.edu',
  hagerstown_cc: 'athletics.hagerstowncc.edu',
  harford_cc: 'harfordathletics.com',
  slcc: 'slccbruins.com',
  snow_college: 'snowbadgers.com',
  north_idaho_college: 'nicathletics.com',
  college_of_southern_idaho: 'athletics.csi.edu',
  colorado_northwestern_cc: 'athletics.cncc.edu',
  usu_eastern: 'usueasternathletics.com',
  truckee_meadows_cc: 'tmcclizards.com',
  pacific_northwest_christian_college: 'pnwccgladiators.com',
  illinois_central: 'illinoiscentralcougars.com',
  southwestern_illinois: 'swic.edu',
  lincoln_trail: 'ltcathletics.com',
  central_georgia_tech: 'cgtctitans.com',
  nwacc: 'nwacceagles.com',
  oxford_college_emory: 'oxfordcollegeathletics.com',
  southern_crescent_tech: 'sctech.edu',
  southwestern_christian: 'swccramathletics.com',
  ranger_college: 'rangersports.net',
  noc_enid: 'nocjets.com',
  efsc:         'efsctitans.com',
  duke:           'goduke.com',
  ncstate:        'gopack.com',
...
const SITE_URLS = {
  ...
  yavapai_college: 'https://www.yc.edu',
  eastern_arizona: 'https://www.eac.edu',
  csn_college: 'https://www.csn.edu',
  community_christian_college: 'https://www.cccollege.edu',
  eastern_oklahoma_state: 'https://www.eosc.edu',
  connors_state: 'https://connorsstate.edu',
  neo_am: 'https://neo.edu',
  rose_state: 'https://rose.edu',
  national_park: 'https://np.edu',
  rich_mountain: 'https://www.uarichmountain.edu',
  hill_college: 'https://www.hillcollege.edu',
  western_texas: 'https://www.wtc.edu',
  truman_college: 'https://www.ccc.edu/truman/',
  daley_college: 'https://www.ccc.edu/daley/',
  malcolm_x_college: 'https://www.ccc.edu/malcolm-x/',
  kennedy_king_college: 'https://www.ccc.edu/kennedy-king/',
  wilbur_wright_college: 'https://www.ccc.edu/wright/',
  coffeyville_cc: 'https://www.coffeyville.edu',
  garden_city_cc: 'https://www.gcccks.edu',
  seward_county_cc: 'https://www.sccc.edu',
  casper_college: 'https://www.caspercollege.edu',
  northwest_college: 'https://www.nwc.edu',
  central_wyoming: 'https://www.cwc.edu',
  laramie_county_cc: 'https://www.lccc.wy.edu',
  gillette_college: 'https://www.gillettecollege.org',
  western_nebraska_cc: 'https://www.wncc.edu',
  lamar_cc: 'https://lamarcc.edu',
  trinidad_state: 'https://trinidadstate.edu',
  northeastern_junior_college: 'https://www.njc.edu',
  usc_lancaster: 'https://www.sc.edu/about/system_and_campuses/lancaster',
  usc_salkehatchie: 'https://www.sc.edu/about/system_and_campuses/salkehatchie',
  usc_sumter: 'https://www.sc.edu/about/system_and_campuses/sumter',
  usc_union: 'https://www.sc.edu/about/system_and_campuses/union',
  paris_jc: 'https://www.parisjc.edu',
  jacksonville_college: 'https://www.jacksonvillecollege.edu',
  northeast_texas_cc: 'https://www.ntcc.edu',
  texas_southmost: 'https://www.tsc.edu',
  crowder_college: 'https://www.crowder.edu',
  jefferson_college_mo: 'https://www.jeffco.edu',
  harcum_college: 'https://www.harcum.edu',
  hagerstown_cc: 'https://www.hagerstowncc.edu',
  harford_cc: 'https://www.harford.edu',
  slcc: 'https://www.slcc.edu',
  snow_college: 'https://www.snow.edu',
  north_idaho_college: 'https://www.nic.edu',
  college_of_southern_idaho: 'https://www.csi.edu',
  colorado_northwestern_cc: 'https://www.cncc.edu',
  usu_eastern: 'https://eastern.usu.edu',
  truckee_meadows_cc: 'https://www.tmcc.edu',
  pacific_northwest_christian_college: 'https://www.pnwcc.edu',
  illinois_central: 'https://icc.edu',
  southwestern_illinois: 'https://www.swic.edu',
  lincoln_trail: 'https://iecc.edu/ltc',
  central_georgia_tech: 'https://www.centralgatech.edu',
  nwacc: 'https://www.nwacc.edu',
  oxford_college_emory: 'https://oxford.emory.edu',
  southern_crescent_tech: 'https://www.sctech.edu',
  southwestern_christian: 'https://www.swcc.edu',
  ranger_college: 'https://www.rangercollege.edu',
  noc_enid: 'https://www.noc.edu',
...
const SOCIAL = {
  ...
  yavapai_college: ['https://www.instagram.com/ycmenssoccer/', 'https://x.com/Yavapai_MSOC', null, null],
  eastern_arizona: ['https://www.instagram.com/eacmenssoccer/', null, null, null],
  csn_college: [null, 'https://x.com/CSN_MSoc', null, null],
  community_christian_college: [null, null, null, null],
  eastern_oklahoma_state: ['https://www.instagram.com/eosc_msoc/', 'https://twitter.com/EOSCSoccer', 'https://www.facebook.com/eoscsoccer', null],
  connors_state: ['https://www.instagram.com/connorsstsoccer/', 'https://x.com/ConnorsStSoccer', 'https://www.facebook.com/ConnorsStateSoccer', null],
  neo_am: ['https://www.instagram.com/neonorsemen/', 'https://x.com/NEONorsemen', 'https://www.facebook.com/NEONorsemen', null],
  rose_state: [null, null, null, 'https://youtube.com/channel/UCeLlSVEqktnrF7PvbSd-RBw'],
  national_park: ['https://www.instagram.com/nighthawkathletics', 'https://twitter.com/NPC_Nighthawks', 'https://www.facebook.com/NPCNighthawkAthletics', 'https://www.youtube.com/@NationalParkCollege/live'],
  rich_mountain: ['https://www.instagram.com/uarmsoccer', null, 'https://www.facebook.com/UARMBucks/', null],
  hill_college: [null, 'https://twitter.com/hc_athletics_', 'https://www.facebook.com/HillCollegeAthletics/', null],
  western_texas: ['https://www.instagram.com/wtc_athletics/', 'https://x.com/WTCAthleticsHPE', 'https://www.facebook.com/westerntexascollegeathletics?fref=ts#', 'https://www.youtube.com/@westerntexascollege'],
  truman_college: ['https://www.instagram.com/trumanfalconsmsoc/', null, null, null],
  daley_college: ['https://www.instagram.com/daleymsoc/', null, null, null],
  malcolm_x_college: [null, null, null, null],
  kennedy_king_college: ['https://www.instagram.com/kennedykingmensoccer/', null, 'https://www.facebook.com/p/Kennedy-King-College-Mens-Soccer-61561309582294/', null],
  wilbur_wright_college: [null, null, null, null],
  coffeyville_cc: ['https://www.instagram.com/red_raven_athletics/', 'https://x.com/redravensports', 'https://www.facebook.com/redravensports', null],
  garden_city_cc: [null, 'https://twitter.com/sportsbuster', 'https://www.facebook.com/GCCCsportsbuster/', 'https://www.youtube.com/channel/UChgXVCD8aPodZZEMc4ov8Gg'],
  seward_county_cc: ['https://www.instagram.com/sewardsaints/', 'https://x.com/SewardSaints', 'https://www.facebook.com/p/Seward-Saints-Athletics-61576990312306/', null],
  casper_college: ['https://www.instagram.com/tbirdmenssoccer/', null, 'https://www.facebook.com/CasperCollegeMensSoccer', null],
  northwest_college: ['https://www.instagram.com/nwctrappers/', 'https://twitter.com/NWCTrappers', 'https://www.facebook.com/TrapperAthletics/', null],
  central_wyoming: ['https://www.instagram.com/cwcrustlers/', null, 'https://www.facebook.com/cwcrustlers/', null],
  laramie_county_cc: ['https://www.instagram.com/lcccmsoc_/', 'https://x.com/lcccsports', null, null],
  gillette_college: ['https://www.instagram.com/pronghornathletics/', null, 'https://www.facebook.com/GCPronghornMSoc', null],
  western_nebraska_cc: ['https://www.instagram.com/wnccmsoccer/', null, 'https://www.facebook.com/WNCCMensSoccer/', null],
  lamar_cc: ['https://www.instagram.com/lcc_athletics/', 'https://x.com/LopesAthletics', 'https://www.facebook.com/profile.php?id=61579169432970', 'https://www.youtube.com/c/LCCAthletics'],
  trinidad_state: [null, null, null, null],
  northeastern_junior_college: ['https://www.instagram.com/northeasternmsoccer/', 'https://x.com/northeasternmsoccer', null, null],
  usc_lancaster: ['https://www.instagram.com/uscl_soccer/', null, 'https://www.facebook.com/LANationSoccer', null],
  usc_salkehatchie: ['https://www.instagram.com/uscsalkathletics/', 'https://twitter.com/USCSalkehatchie', 'https://www.facebook.com/USCSalkAthletics', null],
  usc_sumter: ['https://www.instagram.com/uscsumter_athletics/', null, null, null],
  usc_union: ['https://www.instagram.com/uscunion.soccer/', null, null, null],
  paris_jc: ['https://www.instagram.com/pjcmsoc/', null, null, null],
  jacksonville_college: ['https://instagram.com/jacksonvillecollegesoccer', 'https://x.com/JvilleSoccer', 'https://www.facebook.com/JacksonvilleSoccer', null],
  northeast_texas_cc: ['https://www.instagram.com/ntcc_soccer/', 'https://twitter.com/NTCCSoccer', null, null],
  texas_southmost: ['https://www.instagram.com/tscscorpionsathletics/', null, 'https://www.facebook.com/tscscorpionsathletics/', null],
  crowder_college: [null, null, null, null],
  jefferson_college_mo: [null, null, null, null],
  harcum_college: ['https://www.instagram.com/harcummsoccer/', 'https://x.com/HarcumMSoccer', null, null],
  hagerstown_cc: [null, null, null, null],
  harford_cc: ['https://www.instagram.com/fightingowlsmsoc/', null, null, null],
  slcc: ['https://www.instagram.com/slccbruins/', 'https://twitter.com/slccbruins', 'https://www.facebook.com/bruin.athletics', null],
  snow_college: ['https://instagram.com/snowmsoc', 'https://x.com/SnowCollegeMSOC', null, null],
  north_idaho_college: ['https://instagram.com/nicmenssoccer', 'https://twitter.com/nicmenssoccer', 'https://facebook.com/nicmenssoccer', null],
  college_of_southern_idaho: [null, null, null, null],
  colorado_northwestern_cc: [null, null, null, null],
  usu_eastern: ['https://instagram.com/usueasternsoccer', null, 'https://www.facebook.com/USU-Eastern-Soccer-Team-832233343472172/', null],
  truckee_meadows_cc: ['https://www.instagram.com/tmcc_lizards/', 'https://www.twitter.com/TMCCAthletics', 'https://www.facebook.com/TMCC-Athletics-113911853602912/', null],
  pacific_northwest_christian_college: [null, null, null, null],
  illinois_central: ['https://instagram.com/iccmsoc', null, null, null],
  southwestern_illinois: ['https://www.instagram.com/swicmenssoccer', 'https://x.com/swic_msoc', null, null],
  lincoln_trail: ['https://www.instagram.com/ltcmsoccer', null, 'https://www.facebook.com/LTCMensSoccer', null],
  central_georgia_tech: ['https://www.instagram.com/cgtcathletics/', 'https://twitter.com/cgtcathletics', 'https://www.facebook.com/CGTCAthletics/', null],
  nwacc: ['https://www.instagram.com/nwaccmsoccer/', null, 'https://www.facebook.com/NWACCathletics', 'https://www.youtube.com/@NWACCAthletics'],
  oxford_college_emory: ['https://www.instagram.com/oxfordathletics/', null, 'https://www.facebook.com/oxfordathletics', 'https://www.youtube.com/channel/UC6x7wmGCGMJ-O9csj1S4qvg'],
  southern_crescent_tech: ['https://www.instagram.com/southerncrescenttech/', 'https://twitter.com/SoCrescentTech', 'https://www.facebook.com/SouthernCrescentTech/', 'https://www.youtube.com/channel/UC7zOnMPmc-pMrWtXnJtkNPg'],
  southwestern_christian: ['https://www.instagram.com/swccsoccer/', null, null, null],
  ranger_college: ['https://www.instagram.com/rangermens', null, 'https://www.facebook.com/rangercollegesoccer', null],
  noc_enid: [null, null, null, null],
  ...
  return`
    ...
    <div class="mtab-content" id="tab-standings">
      <div class="detail-block" style="margin-bottom:1rem"><h4>Conference Standings 2020–2025</h4>
        ${u.confMoveNote?`<p style="font-size:12px;color:var(--muted);margin:2px 0 10px;line-height:1.45;padding:8px 10px;background:var(--panel,rgba(127,127,127,.08));border-left:3px solid var(--accent,#b07d1a);border-radius:4px"><strong>Conference note.</strong> ${u.confMoveNote}</p>`:''}
...
function selectFinSchool(id, btnEl){
  ...
  if(u.fin.aidType === 'need-only' || u.fin.maxAthletic === 0){
    ...
    const athCap = finAthleticCapPct(u);
    slAth.max = athCap;
...
// NJCAA Division II athletic aid may cover tuition, fees and books only, never
// housing or food, so the slider stops at that share of the cost of attendance.
function finAthleticCapPct(u){
  const f = u.fin;
  if (u.div === 'JUCO' && u.njcaaDivision === 'II' && f.costNum > 0) {
    return Math.min(100, Math.floor((f.tuition + f.fees) / f.costNum * 100));
  }
  return 100;
}
...
function updateFinModel(){
  ...
  if(u.fin.aidType==='need-only'){
    ...
    const athCap = finAthleticCapPct(u);
    const rideText = athCap < 100
      ? `NJCAA Division II athletic aid can cover tuition, fees and books but not housing or food, so the athletic slider stops at ${athCap}%.`
      : `A full athletic ride = 100% athletic slider.`;
    tips = `<strong>${gap}% gap remaining:</strong> At current settings ${fmt(totalCOA-totalAid)}/yr is unfunded. ${rideText} Institutional aid (the dollar slider) is a bonus the coach can negotiate on top.`;
  } else {
