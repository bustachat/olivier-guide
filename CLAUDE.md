...
- **⏳ OWNER RULING 2026-09-17 — `DIV_STRENGTH` JUCO split: no change unless an outside scale supports it; otherwise it is only our interpretation.** A candidate scale exists and is reported to the owner, not applied: Massey Ratings rates all NJCAA divisions on one scale from game results (masseyratings.com/csoc2025/njcaa/ratings, read in Chrome 2026-09-17, final 2025 season, 252 teams). Mean power: DI (79 teams) +0.39, DII (105) −0.78, DIII (68) −3.48; DI has 17 of the top 25, DII 8, DIII 0. So DII is about 1.2 goals a game below DI and DIII about 3.9 below. Note the guide's four DIII schools (Suffolk, Nassau, Ulster, Westchester) currently get the same 0.6 as DI. Turning goal gaps into 0–1 values is still a choice, and the whole term is worth at most 4 Fit points (divStrength × 0.1 × 40), so any split moves Fit by under 1 point. Awaiting owner decision on whether Massey counts as the scale.
- **🚩 Elite JUCO tiering bar — owner asked for options (2026-09-17), undecided.** The old figures here (21 of 30, ~7 would drop) were stale. Now **39 of 89 JUCOs are Elite (44%)**. The badge is display-only (card chip + modal badge, `jucoTierNote` as the tooltip), no score. Most of the growth came from the gap-fill campaign tagging region champions Elite. Against the written v37.4 rule (2025 national title or runner-up, top-5 national ranking, 2+ 2025 All-Americans, or recent national dominance), about 16–17 hold and about 22–23 would drop (e.g. Mohave, Glendale, Dodge City, Iowa Lakes, Blinn, Coastal Bend, Johnson County, Murray State, Otero, Montgomery, Hill, Western Texas, Truman, Laramie County, Western Nebraska, the three USC campuses, Crowder, Harcum, Harford, Snow; Yavapai and EFSC are borderline). Count by reading each note, not re-verified live.
