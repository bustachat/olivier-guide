...
Campaign plan and session-by-session detail live in the `roster_refresh_campaign_2026` memory. **Next action: the 7 "published but empty" JUCOs below, deferred to late August, plus a `tyler_jc` re-check.**
